...
import ManagePayment from "./Components/admin/users/ManagePayment"
import RazorpayButton from "./Components/Pages/Payment"
function App() {
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/admin" element={<AdminLayout />}>
            ...
            <Route path="breed/add" element={<AddBreed />} />
              <Route path="pets/pets" element={<ViewPets/>} />
              ...
              <Route path="/admin/ngo/add" element={<AddNgo />}/>
                ...
                <Route path="/admin/pets/add" element={<AddPets />}/>
                   <Route path="Pets/edit/:id" element={<Updatepet/>}/>
                     <Route path="/admin/users/ManagePayment" element={<ManagePayment />}/>
          </Route>
        ...
        <Route path="pet/listing" element={<PetListing/>}/>
          ...
          <Route path="/*" element={<Error />} />
           <Route path="/Components/Pages/Payment" element={<RazorpayButton/>}/>    
        </Routes>
      </BrowserRouter>
      <ToastContainer />
    </>
