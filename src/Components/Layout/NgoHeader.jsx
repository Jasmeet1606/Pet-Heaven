        ...
        >
            ...
            <div className="collapse navbar-collapse" id="ftco-nav">
                ...
                <li className="nav-item">
                    <Link to="/Ngo/pet/listing" className="nav-link">
                    Home
                    </Link>
                </li>
                {/* <li className="nav-item">
                ...
                <li class="dropdown nav-item">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        ...
                        <Link class="dropdown-item" to={"/Ngo/pet/dogs"}>Dogs</Link>
                        <Link class="dropdown-item" to={"/Ngo/pet/cats"}>Cats</Link>
                        <Link class="dropdown-item" to={"/Ngo/pet/view"}>Pets</Link>
                    </div>
                </li>
