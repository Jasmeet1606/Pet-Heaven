...
//         let PetCount= await getCountFromServer(collection(db,"Pets"))
//         setPet(PetCount.data().count);
        
//     }
//      const fetchreqCount=async ()=>{
//         let reqCount= await getCountFromServer(collection(db,"adoptions"))
//         setadoptions(reqCount.data().count);
...
//             </div>
//             <div className="media-body">
//               <h3 className="heading">View Pets</h3>
//               <h1>{pet}</h1>
//               <Link to="/admin/pets/pets"
//                 className="btn-custom d-flex align-items-center justify-content-center"
//               >
//                 <span className="fa fa-chevron-right" />
//                 <i className="sr-only">Read more</i>
...
//         </div>
//      </div>
//        <div className="col-md-4 mt-5 d-flex align-self-stretch px-4 ftco-animate">
//           <div className="d-block mt-5 services text-center">
//             <div className="icon d-flex align-items-center justify-content-center">
//               <span className="flaticon-grooming" />
//             </div>
//             <div className="media-body">
//               <h3 className="heading">Adoption Requests</h3>
//               <h1>{adoptions}</h1>
//               <Link to="/admin/pages/adoption"
//                 className="btn-custom d-flex align-items-center justify-content-center"
//               >
//                 <span className="fa fa-chevron-right" />
//                 <i className="sr-only">Read more</i>
